...
const menuArray = [
  ...
  },
  {
    title: "세대안내",
    subMenu: [
      { subTitle: "39㎡", subUrl: "/FloorPlan/39" },
      { subTitle: "59A", subUrl: "/FloorPlan/59A" },
      { subTitle: "59B", subUrl: "/FloorPlan/59B" },
      { subTitle: "77A", subUrl: "/FloorPlan/77A" },
      { subTitle: "77B", subUrl: "/FloorPlan/77B" },
      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu(!isMobileMenu)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#f28d1f" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#f28d1f" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
          ...
          <a href="tel:1533-8848">
            <IoCall className={styles.icon} size={25} color="#f28d1f" />
          </a>
        </div>
