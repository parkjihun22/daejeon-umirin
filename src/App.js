  ...
  return (
    <BrowserRouter>
        <Routes>
          ...
          <Route path="/FloorPlan/39" element={<FloorPlan1 />} />
          <Route path="/FloorPlan/59A" element={<FloorPlan2 />} />
          <Route path="/FloorPlan/59B" element={<FloorPlan3 />} />
          <Route path="/FloorPlan/77A" element={<FloorPlan4 />} />
          <Route path="/FloorPlan/77B" element={<FloorPlan5 />} />
          <Route path="/FloorPlan/84A" element={<FloorPlan6 />} />
          <Route path="/FloorPlan/84B" element={<FloorPlan7 />} />
