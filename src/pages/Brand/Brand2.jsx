  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://www.marvelpartners.co.kr/Brand/video" />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta property="og:title" content="대전 성남 우미린 - 홍보영상" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.marvelpartners.co.kr/Brand/video"
        />
          ...
          {`
															{
																...
																"url": "https://www.marvelpartners.co.kr/Brand/video"
															}
															`}
        </script>
      </Helmet>
