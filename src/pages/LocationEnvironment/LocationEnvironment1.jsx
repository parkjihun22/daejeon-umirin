...
const LocationSection = [
  {
    ...
    contentText:
      "단지 인근 다수의 정비사업 추진 계획에 따라<br />주거환경 개선과 지역경제 활성화<br />가치 상승으로 주목받는 1,213세대",
  },
  {
    img: section2Image2,
    titleText: "차량량5분으로<br />의세권을 누리릴 수 있는 프리미엄",
    contentText:
      "대전의 상급병원인 대전한국병원을<br />단지인근에서<br /> 누릴 수 있는 의세권 프리미엄",
  },
  {
    img: section2Image3,
    titleText: "수도권 시내·외를 더 빠르게<br />광역으로 통하는 특급 교통",
    contentText:
      "대전역, 대전IC<br />1호선, SRT (현재운행중), KTX, 대전도시철도 2호선(계획)으로<br /> 광역교통 프리미엄",
  },
  {
    img: section2Image4,
    titleText:
    ...
    contentText:
      "단지 인근 내 초·중·고 모두 개교예정 정<br />이마트, 코스트코 , CGV 등 편의시설 인접",
  },
  {
    img: section2Image5,
    titleText: "품격있는 주거공간 프리미엄",
    contentText:
      " 타워형,판상형의 조화로운 설계로 활용도 높은 주거공간<br/>영구조망권으로 조망권프리미엄까지",
  },
  {
    img: section2Image6,
    titleText:
      "대전 최대 중심상업지구<br />도보 3분내로 근접<br /> 단지 앞 도서관,공원프리미엄까지  ",
    contentText:
      " 대전복합터미널과 연계된 이마트, CGV <br />영풍문고 및 가깝고 풍부한 생활인프라",
  },
];
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://www.marvelpartners.co.kr/LocationEnvironment/intro" />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="대전 성남 우미린 - 입지안내"
        />
        <meta
        ...
        <script type="application/ld+json">
          {`
			 ...
			 "url": "https://www.marvelpartners.co.kr/LocationEnvironment/intro"
				 }
				 `}
        </script>
      </Helmet>
      ...
      <p className={styles.screenReaderOnly}>
        대전 성남 우미린의 입지 안내 페이지는 이 단지의 위치와 주변 인프라에
      ...
      <div className={styles.textBox}>
        <div>갈수록 완벽해질 대전</div>
        <div>살수록 높아질</div>
        <div>도시를 압도할 자부심 대전 성남 우미린</div>
      </div>

      <img
        src={page1}
        className={styles.image2}
        alt="대전 성남 우미린 입지환경 안내 이미지"
      />
