  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="대전 성남 우미린 , 대전 성남 우미린, 대전 성남 우미린 모델하우스"
        />
        <link
          rel="canonical"
        ...
        <script type="application/ld+json">
          {`
			...
			"url": "https://www.marvelpartners.co.kr/ComplexGuide/detailintro"
					}
					`}
        </script>
      </Helmet>
