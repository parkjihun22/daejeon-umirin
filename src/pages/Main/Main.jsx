...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `앞선 직주근접 라이프`,
    text2: `단지 인근 다수의 정비사업 추진 계획<br />
            지역경제활성화, 가치 상승으로 주목받는 <br /> 직주근접 프리미엄`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `안심학세권 프리미엄`,
    text2: `단지인근 도보권내 위치한,<br />
            가양초,성남초교 등 안심학세권 프리미엄`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `대전을 한번에 연결하는 광역교통망`,
    text2: `대전역(KTX,SRT). 대전IC 동서대로<br />
            대전 도시철도 2호선(계획) 등`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `기대되는 미래가치`,
    text2: `대전도심융합특구(계획),<br />
           대전역세권복합개발, 등에 따른 미래가치`,
      ...
      {!isMobile ? (
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            <img src={mainImage} className={styles.mainImage} alt="대전 성남 우미린-mainimage1" />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox}>
              <div className={styles.mainImageTextSub}>
                중도금 전액 무이자 <span className={styles.greyText}>착한분양가</span> | 부담을 덜어주는 <span className={styles.greyText}>착한 옵션</span> | 계약금 5%로 내집마련기회 <span className={styles.greyText}>착한조건</span>
              </div>
              <div className={styles.mainImageTitleBox}>
                <div className={styles.mainImageText}>대전이 기다린 가장 착한 아파트</div>
                <div className={styles.mainImageLine}></div>
                <div className={styles.mainImageText}>대전 성남 우미린</div>
              </div>
          ...
          <div className={styles.section}>
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                - 복합터미널, 이마트, CGV, 대전한국 병원<br />
                - 대전역 KTX, SRT  대전도심융합특구, 대전 역세권 개발사업<br />
                - 모두를 누리는 대전 성남 우미린 뉴시티
                </div>
              ...
              <div className={styles.menuBox}>
                <img src={section1_Image1} alt="대전 성남 우미린브랜드소개-image2" />
          ...
          <div className={styles.section}>
            <div className={styles.section8}>
              ...
              <img src={section8Img3} alt="대전 성남 우미린입지환경소개-image2" />
            </div>
          </div>
            ...
            <div className={styles.section2}>
              <div className={styles.textBox}>
                ...
                <div className={`${styles.text2} fadeUpRepeat`}>
                  기대한 모든 프리미엄이<br />대전 성남 우미린에서 펼쳐집니다
                </div>
              ...
              <img src={section2_Image1} alt="대전 성남 우미린아파트 조감도-image3" />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img src={section4_Image1} alt="대전 성남 우미린브랜드소개-image4" />
                <div className={styles.text1}>대전 성남 우미린</div>
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="대전 성남 우미린오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img src={mobileImageMain} className={styles.mainImage} alt="대전 성남 우미린mobilemain-image1" />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
              ...
              <div className={styles.mainImageTitleBox1}>
                ...
                <div className={styles.mainImageText5}>대전 성남 우미린</div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.container7}>
            ...
            <img src={section8Img3} alt="대전 성남 우미린mobile입지안내-image1" />
          </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text2} fadeUpRepeat`}>
                기대한 모든 프리미엄이<br />
                대전 성남 우미린에서<br /> 펼쳐집니다
              </div>
              <div className={`${styles.text3} fadeUpRepeat`}>SPECIAL PLAN</div>
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른<br />
                프리미엄 주거라이프를 <br />대전 성남 우미린 모델하우스에서 확인하세요
              </div>
            </div>
            <img src={section2_Image1} alt="대전 성남 우미린mobile조감도-image1" />
          </div>
